...
namespace Thetis.AppPages.Auxiliary.Kladoi
{
    /// <summary>
    /// Interaction logic for EidikotitaGrid.xaml
    /// </summary>
    public partial class EidikotitaGrid : Page
    {
        ...
        private void dataGrid_CellValidating(object sender, GridViewCellValidatingEventArgs e)
        {
            ...
            {
                string strklados = e.NewValue.ToString();
                if (String.IsNullOrWhiteSpace(strklados))
                {
                    e.IsValid = false;
        ...
        {
            ΕΙΔΙΚΟΤΗΤΑ eidikotita = e.Row.DataContext as ΕΙΔΙΚΟΤΗΤΑ;
