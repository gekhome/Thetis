...
{
    /// <summary>
    /// Interaction logic for Spoudes.xaml
    /// </summary>
    public partial class Spoudes : Page
    {
        private ThetisDataContext db = new ThetisDataContext();
        private ObservableCollection<ΣΠΟΥΔΕΣ> oc = new ObservableCollection<ΣΠΟΥΔΕΣ>();
        ...
        public void LoadData()
        {
            ...
            */ 
            var oc = new ObservableCollection<ΣΠΟΥΔΕΣ>(spoudes.ToList());

            dataGrid.ItemsSource = null;
            dataGrid.ItemsSource = oc;       //was spoudes.ToList()
        }
        ...
        private void btnDelete_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ΣΠΟΥΔΕΣ spoudes = row as ΣΠΟΥΔΕΣ;
                db.ΣΠΟΥΔΕΣs.DeleteOnSubmit(spoudes);
            }
        }
        ...
        private void dataGrid_RowEditEnded(object sender, GridViewRowEditEndedEventArgs e)
        {
            ...
            if (e.EditOperationType == GridViewEditOperationType.Insert)
            {
                ...
                ΣΠΟΥΔΕΣ spoudes = row.Item as ΣΠΟΥΔΕΣ;           // cast it to object ΣΠΟΥΔΕΣ

                // these two methods do the database udpating
                db.ΣΠΟΥΔΕΣs.InsertOnSubmit(spoudes);            // insert new row into collection
            }
        }
